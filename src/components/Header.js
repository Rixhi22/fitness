...
/>
        ...
        <div className="cta">
          {isAuthenticated ? (
            <a className="btn" style={{backgroundColor:'#000',color:'#fff'}} onClick={onLogoutClick}>Logout</a>
          ) : (
            <>
              <a className="btn" style={{backgroundColor:'#000',color:'#fff'}} onClick={onLoginClick}>Login</a>
              <a className="btn" style={{backgroundColor:'#000',color:'#fff'}} onClick={onSignupClick}>Sign up</a>
            </>
          )}
        </div>
